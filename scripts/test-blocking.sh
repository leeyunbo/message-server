...
# V1: Blocking Mode Test
# Run local server with blocking mode and execute k6 load test
...
echo "========================================="
echo "V1: Blocking Mode Load Test"
echo "========================================="
echo "Target: $SERVER_URL"
echo "InfluxDB: $INFLUXDB"
echo ""
echo "Expected results:"
echo "  - High latency (p95 >500ms)"
echo "  - EventLoop blocking logs"
echo "  - Cascading failures"
echo "========================================="
echo ""
...
if [ "$INFLUXDB" = "true" ]; then
    ...
    k6 run --out influxdb=http://localhost:8086/k6 k6/blocking-test.js
else
    k6 run k6/blocking-test.js
fi
